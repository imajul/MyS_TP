...
HD_PWD='C:/Microarquitecturas_y_softcores/MyS_TP_final/encoder/encoder.runs/system_encoder_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_encoder_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_encoder_ip_0_0.tcl
