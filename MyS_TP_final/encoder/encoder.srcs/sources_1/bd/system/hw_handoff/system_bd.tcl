...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set channel_A_i [ create_bd_port -dir I channel_A_i ]
  set channel_B_i [ create_bd_port -dir I channel_B_i ]
  set rst_i [ create_bd_port -dir I rst_i ]

  # Create instance: encoder_ip, and set properties
  set encoder_ip [ create_bd_cell -type ip -vlnv xilinx.com:user:encoder_ip:1.0 encoder_ip ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins encoder_ip/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net channel_A_i_1 [get_bd_ports channel_A_i] [get_bd_pins encoder_ip/channel_A_i]
  connect_bd_net -net channel_B_i_1 [get_bd_ports channel_B_i] [get_bd_pins encoder_ip/channel_B_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins encoder_ip/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_i_1 [get_bd_ports rst_i] [get_bd_pins encoder_ip/rst_i]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins encoder_ip/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs encoder_ip/S_AXI/S_AXI_reg] SEG_encoder_ip_S_AXI_reg
